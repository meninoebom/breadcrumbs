# Building Breadcrumbs in Public

A developer learning to be a founder, one feature at a time.

Each entry captures what was built, what was learned, and the product thinking behind it. Not a changelog — a learning journal.

**Project:** [Breadcrumbs](../../README.md) — a blog of collected thought atoms organized into themes.

**Stack:** FastAPI + SQLModel + PostgreSQL (backend), React + TanStack + Tailwind (frontend).
